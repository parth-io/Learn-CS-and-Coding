...
def count_syllables_in_word(word):
    ...
    vowels = "aeiouAEIOU"
##Your idea of testing for double vowels involved somee weird double variables
##and didn't work out, obviously. Boolean is much cleaner.
...
def count_sentences(text):
    ...
    for char in text:
        if char in terminals:
            count = count + 1
##A more quaint way to do this is as follows:
##    for char in text:
...
if __name__ = '__main__'
    import Analysing_text_ch1text 
##The reason why we include a .text is to call the variable text from the imported
##module.
    compute_readability(Analysing_text_ch1text.text)
