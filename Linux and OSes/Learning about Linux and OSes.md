...
- [Command Line](#command-line)
    * [tty and the GUI](#tty-and-the-gui)
        + [Booting into tty or into GUI](#booting-into-tty-or-into-gui)
    * [Basics](#basics)
- [User Environments](#user-environments)
    * [Root](#root)
    * [Start-up](#start-up)
    * [Login vs Non-login & Interactive vs Non-interactive](#login-vs-non-login---interactive-vs-non-interactive)
    * [Aliases](#aliases)
...
- [Shells](#shells)
    ...
    * [Subshells and Child Processes](#subshells-and-child-processes)
        + [Beware inheritance of shell and environmental variables across childshells, subshells, and child processes](#beware-inheritance-of-shell-and-environmental-variables-across-childshells--subshells--and-child-processes)
...
- [Permissions](#permissions)
    ...
    * [Representing rights](#representing-rights)
- [Linux File System](#linux-file-system)
    ...
    * [/boot](#-boot)
    * [/lib; /lib64](#-lib---lib64)
    * [/media; /run; /mnt](#-media---run---mnt)
    * [/opt; /sys; /srv; /tmp; /usr](#-opt---sys---srv---tmp---usr)
    * [/usr](#-usr)
- [Networking](#networking)

<small><i><a href='http://ecotrust-canada.github.io/markdown-toc/'>Table of contents generated with markdown-toc</a></i></small>
<small><-- Should actually be generated by Typora, but sometimes Typora acts up</small>
